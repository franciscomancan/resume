...
<div id="logo-wrap">
<div id="logo">
	<h1><a href="/stadosweb/">stados</a></h1>
...
<div id="page">	
	...
	<div id="content">
		...
		<div id="stados-context">		
			...
			<div style="margin-top:10px;margin-left:50px"><a href="javascript:history.go(-1)">go back</a>&nbsp;|&nbsp;<a href="/stadosweb">return to login</a></div>
		</div>
	</div>
	<!-- end content -->	
